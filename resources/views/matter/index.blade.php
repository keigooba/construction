      ...
      <div class="panel panel-default">
        <div id="main-control" class="panel-heading">
          ...
          <div class="form-inline date-range pull-right">
            ...
            <form action="{{route('matter')}}" method="post">
            @csrf
              <span class="input-group">
                <span class="input-group-addon">表示期間</span>
                <input type="date" class="form-control start-date" name="start_date" value="{{$start_date[0]->start_date}}">
                <span class="input-group-addon date-range-wavedash">～</span>
                <input type="date" class="form-control end-date" name="end_date" value="{{$end_date[0]->end_date}}">
